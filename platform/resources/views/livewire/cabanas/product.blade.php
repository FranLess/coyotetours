                    ...
                    <div class="row align-items-center product-detail-top">
                                                ...
                                                <div class="carousel-item @if ($loop->first) active @endif}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="gallery-container">
                                                            <div class="gallery">
                                                                <a href='{{ asset("img/cabanas/habitaciones/$image->imagen") }}'
                                                                    data-lightbox="models">
                                                                    <img class="img-fluid" style="height: 100%;"
                                                                        src='{{ asset("img/cabanas/habitaciones/$image->imagen") }}'>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-5">
                            <div class="product-content">
                                ...
                                <input type="hidden" value=" {{ $product->precio_noche_base }} " name="priceAdulto">
                                ...
                                <form action="{{ route('cart.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="categoria" value="cabana">
