<div>
    ...
    <script>
        window.addEventListener('load', () => {
            Livewire.on('borrarAsk', (cabanaHabitacionCategoria) => {
                let ask = confirm('El registro no podra restaurase');
                if (ask) Livewire.emit('borrarCabanaHabitacionCategoria', cabanaHabitacionCategoria.cabanaHabitacionCategoria);
            });
        });
    </script>
</div>
