                    ...
                    <div class="row align-items-center product-detail-top">
                                                ...
                                                <div class="carousel-item active{{-- @if ($loop->first) active @endif --}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="gallery-container">
                                                            <div class="gallery">
                                                                <a href='{{ asset("img/paquetes/$paquete->imagen") }}'
                                                                    data-lightbox="models">
                                                                    <img class="img-fluid" style="height: 100%;"
                                                                        src='{{ asset("img/paquetes/$paquete->imagen") }}'>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-5">
                            <div class="product-content">
                                ...
                                <form action="{{ route('cart.store') }}" method="post" enctype="multipart/form-data" name="">
                                    @csrf
                                    <h3>
                                        <label for="precio1">{{ $paquete->precio }} MXN</label>
                                        <input type="radio" value="{{$paquete->precio}}" name="precio" id="precio1">
                                        <label for="precio2">{{ $paquete->precio2 }} MXN</label>
                                        <input type="radio" value="{{$paquete->precio2}}" name="precio" id="precio2">
                                    </h3>
                                    <div class="quantity">
                                        <h4>Fecha:</h4>
                                        <div class="qty">
                                    ...
                                    <input type="hidden" name="categoria" value="paquete">
